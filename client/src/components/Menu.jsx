...
const Menu = ({ setMenuOpen, darkMode, setDarkMode, setUploadOpen }) => {
    ...
    return (
        <MenuContainer setMenuOpen={setMenuOpen}>
            ...
            <Link to='/blog' style={{ textDecoration: "none", color: "inherit", width: '100%' }}>
                <Elements>
                    <BookIcon />
                    <NavText>Blog</NavText>
                </Elements>
            </Link>
            <Link to='/chatbox' style={{ textDecoration: "none", color: "inherit", width: '100%' }}>
                <Elements>
                    <BookIcon />
                    <NavText>ChatGPT</NavText>
                </Elements>
            </Link>
            {
                currentUser ?
