...
import BlogAll from "./pages/BlogAll.jsx";
...
function App() {
  ...
  const [upChatbotOpen, setChatbotOpen] = useState(false);
    ...
    <ThemeProvider theme={darkMode ? darkTheme : lightTheme}>
      <BrowserRouter>
        ...
        {SignUpOpen && (
         ...
         {upChatbotOpen && <Chatbot setChatbotOpen={setChatbotOpen} />}
        ...
        <Podstream>
          ...
          <Frame>
            ...
            <Routes>
              ...
              <Route path="/blog" exact element={<BlogAll />} />
              <Route path="/blog/:name" exact element={<Blog />} />
              <Route path="/chats" exact element={<Chatbox />} />
              ...
              <Route path="/analyst" exact element={<Analyst />} />
              <Route
